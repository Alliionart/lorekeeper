...
Route::group(['prefix' => 'account', 'namespace' => 'Users'], function () {
    ...
    Route::get('invitations', 'AccountController@getGuildInvitations');
    Route::post('guild-invitations', 'AccountController@postGuildInvitations');
...
Route::group(['prefix' => 'submissions', 'namespace' => 'Users'], function () {
    ...
    Route::get('new/guild/{id}', 'SubmissionController@getGuildInfo');
