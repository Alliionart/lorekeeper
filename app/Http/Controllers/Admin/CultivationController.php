...
class CultivationController extends Controller {
    ...
    public function postCreateEditArea(Request $request, CultivationService $service, $id = null) {
        ...
        $area = null;
        if (!$id) {
            $area = $service->createArea($data);
        } elseif ($id) {
            $area = $service->updateArea(CultivationArea::find($id), $data);
        }
        if ($area) {
    ...
    public function postCreateEditPlot(Request $request, CultivationService $service, $id = null) {
        ...
        $plot = null;
        if (!$id) {
            $plot = $service->createPlot($data);
        } elseif ($id) {
            $plot = $service->updatePlot(CultivationPlot::find($id), $data);
        }
        if ($plot) {
