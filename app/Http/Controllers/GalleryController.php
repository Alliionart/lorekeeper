...
class GalleryController extends Controller {
    ...
    */
    ...
    public function postCreateEditGallerySubmission(Request $request, GalleryManager $service, $id = null) {
        ...
        $data = $request->only(['image', 'text', 'title', 'description', 'slug', 'collaborator_id', 'collaborator_data', 'participant_id', 'participant_type', 'gallery_id', 'alert_user', 'prompt_id', 'content_warning', 'external_name', 'external_link', 'location_id']);
