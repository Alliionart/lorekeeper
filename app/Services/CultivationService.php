...
class CultivationService extends Service {
    ...
    **********************************************************************************************/
     ...
     * @param array $data
     *
     * @return bool|CultivationArea
     */
    public function createArea($data) {
        DB::beginTransaction();

        try {
            if (CultivationArea::where('name', $data['name'])->exists()) {
    ...
    public function updateArea($area, $data) {
        ...
        if (CultivationArea::where('name', $data['name'])->where('id', '!=', $area->id)->exists()) {
            throw new \Exception('The name has already been taken.');
        }
        ...
        if (isset($data['background_image']) && $data['background_image']) {
            if (isset($area->background_extension)) {
                $old = $area->backgroundImageFileName;
            } else {
                $old = null;
            }
            $bgImage = $data['background_image'];
        ...
        $plotImage = null;
        if (isset($data['plot_image']) && $data['plot_image']) {
            if (isset($area->thumb_extension)) {
                $old = $area->thumbFileName;
            } else {
                $old = null;
            }
            $plotImage = $data['plot_image'];
        ...
        if (isset($data['plot_id'])) {
            ...
            foreach (array_filter($data['plot_id']) as $plot_id) {
                if ($area->plotAreas->where('plot_id', $plot_id)->where('area_id', $area->id)->count() <= 0) {
    ...
    public function deleteArea($area) {
        ...
        try {
            if (UserArea::where('area_id', $area->id)->exists()) {
                throw new \Exception('This area is unlocked by a user and cannot be deleted.');
            }
    ...
    **********************************************************************************************/
     ...
     * @param array $data
     *
     * @return bool|CultivationPlot
     */
    public function createPlot($data) {
        DB::beginTransaction();

        try {
            if (CultivationPlot::where('name', $data['name'])->exists()) {
                throw new \Exception('The name has already been taken.');
            }
    ...
    public function updatePlot($plot, $data) {
        // More specific validation
        if (CultivationPlot::where('name', $data['name'])->where('id', '!=', $plot->id)->exists()) {
            throw new \Exception('The name has already been taken.');
        }
        ...
        if (isset($data['stage_1_image']) && $data['stage_1_image']) {
            if (isset($plot->stage_1_extension)) {
                $old = $plot->getStageImageFileNameAttribute(1);
            } else {
                $old = null;
            }
            $stage1Image = $data['stage_1_image'];
        ...
        if (isset($data['stage_2_image']) && $data['stage_2_image']) {
            if (isset($plot->stage_2_extension)) {
                $old = $plot->getStageImageFileNameAttribute(2);
            } else {
                $old = null;
            }
            $stage2Image = $data['stage_2_image'];
        ...
        if (isset($data['stage_3_image']) && $data['stage_3_image']) {
            if (isset($plot->stage_3_extension)) {
                $old = $plot->getStageImageFileNameAttribute(3);
            } else {
                $old = null;
            }
            $stage3Image = $data['stage_3_image'];
        ...
        if (isset($data['stage_4_image']) && $data['stage_4_image']) {
            if (isset($plot->stage_4_extension)) {
                $old = $plot->getStageImageFileNameAttribute(4);
            } else {
                $old = null;
            }
            $stage4Image = $data['stage_4_image'];
        ...
        if (isset($data['stage_5_image']) && $data['stage_5_image']) {
            if (isset($plot->stage_5_extension)) {
                $old = $plot->getStageImageFileNameAttribute(5);
            } else {
                $old = null;
            }
            $stage5Image = $data['stage_5_image'];
        ...
        if (isset($data['item_id'])) {
            ...
            foreach (array_filter($data['item_id']) as $item_id) {
                if ($plot->plotItems->where('item_id', $item_id)->where('plot_id', $plot->id)->count() <= 0) {
                    PlotItem::create(['plot_id' => $plot->id, 'item_id' => $item_id]);
                }
            }
        }
    ...
    public function deletePlot($plot) {
        ...
        try {
            if (UserPlot::where('plot_id', $plot->id)->exists()) {
                throw new \Exception('This plot is in use by a user and cannot be deleted.');
            }
