    ...
    @else
        ...
        <div class="row mx-0 px-0">
            ...
            <div class="form-group col-12 row col-md-6 px-0 pl-md-1 pr-md-0">
                ...
                <div class="col-6 col-md-4 text-right">{!! Form::checkbox('prereq_is_same', 1, isset($research->id) && $research->parent_id == $research->prerequisite_id ? 1 : 0, [
                    'class' => 'form-check-input',
                    'data-toggle' => 'toggle',
                    'data-on' => 'Parent is Prerequisite',
                    'data-off' => 'Different Prerequisite',
                ]) !!}</div>
            </div>
        </div>
        ...
        <div class="row mx-0 px-0">
            <div class="form-group col-12 row col-md-6 px-0 pl-md-2 pr-md-0">
                <div class="col-12">{!! Form::label('Fontawesome Icon (Optional)') !!} - <a href="https://fontawesome.com/icons?d=gallery&s=solid&m=free" data-toggle="tooltip"
                        title="If some free icons aren't loading, you may need to manually install an updated version of FontAwesome on your site.">Examples</a></div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#tree").change(function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ url('admin/data/research/parent') }}?tree=" + tree + "&id=" + id,
                    dataType: "text"
                }).done(function(res) {
                    $("#parentSpot").html(res);
