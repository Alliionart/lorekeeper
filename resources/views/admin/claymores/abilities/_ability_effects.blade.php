        ...
        <div class="col-md-6 d-flex">
            <div class="form-group w-100">
                ...
                {!! Form::select($header.'__target', [
                    ...
                    'all_ally'              => 'All Allies',   
                ], isset($fields) && isset($fields['target']) ? $fields['target'] : null, ['class' => 'form-control target_selector']) !!}
            </div>
        ...
        <div class="row" data-index="0">
            <div class="col-md-3">
                <div class="form-group w-100">
                    ...
                    {!! Form::select($header.'__effect_type', [
                        ''                      => 'Select Effect Type',
                        ...
                        'summon'                => 'Summon' 
                    ], isset($fields) && isset($fields['effect_type']) ? $fields['effect_type'] : null, ['class' => 'form-control effect-type']) !!}
                </div>
            </div>
            <div class="col-md-3  {{ $effect_type === 'status' ? '' : 'hide' }}" data-type="status">
                <div class="form-group w-100">
                    {!! Form::label('Status Effect Action') !!}
                    {!! Form::select($header.'__status_action', [
                        ''                      => 'Select Action...',
                        'inflict'               => 'Inflict',
                        'cure'                  => 'Cure',
                    ], isset($fields) && isset($fields['status_action']) ? $fields['status_action'] : null, ['class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="col-md-3 {{ $effect_type === 'immune' ? '' : 'hide' }}" data-type="immune">
                <div class="form-group w-100">
                    ...
                    {!! Form::select($header.'__immune_to', [
                        ''                      => 'Select Immunity...',
                        'next_attack'           => 'Next Attack (Auto-Dodge)',
                        'status'                => 'Status Effect(s)',
                    ], isset($fields) && isset($fields['immune_to']) ? $fields['immune_to'] : null, ['class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="col-md-9 border border-secondary p-2 {{ $effect_type === 'summon' ? '' : 'hide' }}" data-type="summon">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        {!! Form::select($header.'__summon_type', [
                            ''                      => 'Select Type...',
                            'default'               => 'Default',
                            'shield'                => 'Shield',
                        ], isset($fields) && isset($fields['summon_type']) ? $fields['summon_type'] : null, ['class' => 'form-control']) !!}
                    </div>
                    <div class="col-md-3">
