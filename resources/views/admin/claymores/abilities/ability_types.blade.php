...
@section('admin-content')
    ...
    <div class="text-right mb-3"><a class="btn btn-primary mr-3" href="{{ url('admin/abilities/') }}"><i class="fas fa-arrow-left mr-2"></i>Back</a><a class="btn btn-primary" href="{{ url('admin/abilities/types/create') }}"><i class="fas fa-plus"></i> Create
            New Type</a></div>
    @if (!count($types))
