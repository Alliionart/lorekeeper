<div class="row trait-row mb-2 p-3 border border-secondary rounded mx-0{{ $data ? ' delete' : '' }}" type="trait" data-row="0" data="row-start">
    <div class="col-md-12">
        <strong>Applies to </strong> {!! Form::select('traits[0][feature_categories][]', $featureCategories, null, ['class' => 'form-control selectize', 'id' => 'feature_category_id', 'multiple', 'placeholder' => 'Select Trait Categories to Apply Rates to']) !!}
    </div>
