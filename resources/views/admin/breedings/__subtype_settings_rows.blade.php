<div class="row subtype-row mb-2 p-3 border border-secondary rounded mx-0{{ $data ? ' delete' : '' }}" type="subtype" data-row="0" data="row-start">
    <div class="col-md-12 d-inline-flex align-items-center form-group mb-0">
        {!! Form::select('subtypes[{{ $index }}][parent][0]', $subtypes, null, ['class' => 'form-control', 'id' => 'subtype']) !!}
        <span class="mx-4">x</span>
        {!! Form::select('subtypes[{{ $index }}][parent][1]', $subtypes, null, ['class' => 'form-control', 'id' => 'subtype']) !!}
            ...
            <div class="repeaterBody subgroup">
                <div class="row mb-2" type="subtypeSub" data="row-start">
                    <div class="col-md-4 form-group mb-0">
                        {!! Form::select('subtypes[{{ $index }}][results][{{ $subIndex }}][subtype]', $subtypes, null, ['class' => 'form-control', 'id' => 'subtype_result']) !!}
                    </div>
                    <div class="col-md-4 form-group mb-0">
                        {!! Form::number('subtypes[{{ $index }}][results][{{ $subIndex }}][rate]', null, ['class' => 'form-control', 'id' => 'subtype_result_rate', 'placeholder' => 'Rate (%)', 'min' => 0, 'max' => 100]) !!}
                    </div>
