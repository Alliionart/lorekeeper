...
@section('admin-content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {!! Form::checkbox('allow_wingspan', 1, $species->id ? $species->allow_wingspan : 1, ['class' => 'form-check-input', 'data-toggle' => 'toggle']) !!}
                {!! Form::label('allow_wingspan', 'Allow Wingspan', ['class' => 'form-check-label ml-3']) !!} {!! add_help('If turned off, the species will not have wingspan measurements available.') !!}
            </div>
        </div>
    </div>
