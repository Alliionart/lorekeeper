...
@section('profile-title')
    {{ $user->name }}'s {{ $pet->pet->name }} {{ isset($pet->drops->dropData->name) ? strtolower($pet->drops->dropData->name) . 's' : 'drops' }}
@endsection
                ...
                @if ($drops->petItem || $drops->variantItem)
                    ...
                    @if ($drops->petItem)
                        <div class="row">
                            ...
                            <div class="col-md align-self-center">
                                @if ($drops->petItem->has_image)
                                    <img src="{{ $drops->petItem->imageUrl }}"><br />
                                @endif
                    ...
                    @if ($drops->variantItem)
                        <div class="row">
                            ...
                            <div class="col-md align-self-center">
                                @if ($drops->variantItem->has_image)
                                    <img src="{{ $drops->variantItem->imageUrl }}"><br />
                                @endif
