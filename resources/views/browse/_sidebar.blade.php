<ul>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ url('masterlist') }}" class="{{ set_active('masterlist*') }}">{{ __('lorekeeper.characters') }}</a></div>
        <div class="sidebar-item"><a href="{{ url('myos') }}" class="{{ set_active('myos*') }}">{{ __('lorekeeper.myos') }}</a></div>
    </li>
