<ul>
    ...
    <li class="sidebar-section">
        ...
        @if (Auth::check())
            <div class="sidebar-item"><a href="{{ url('research/unlocked') }}" class="{{ set_active('research/unlocked') }}">Unlocked Research</a></div>
            <div class="sidebar-item"><a href="{{ url('research/history') }}" class="{{ set_active('research/history') }}">My Research History</a></div>
        @endif
    </li>
</ul>
